...
open class WTYPanoramaView: UIView {
    ...
    func rotateAccordingToDeviceMotionRotationRate(_ gyroData:CMGyroData) {
        ...
        if abs(rotationRate) >= CRMotionViewRotationMinimumThreshold {
            ...
            UIView.animate(withDuration: 1, delay: 0.0, options: [.beginFromCurrentState, .allowUserInteraction, .curveEaseOut], animations: { () -> Void in
